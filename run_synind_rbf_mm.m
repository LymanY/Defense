...
%         acc3= frtsvmclass(frtsvm_struct,test_data,test_label);
        ...
        if numel(clean_index) ~= 0 
            model_dbscan = libsvmtrain(dirty_label(clean_index,:), dirty_data(clean_index,:) ,'-c 8 -g 0.005');
        ...
        model_clean = libsvmtrain(clean_label,clean_data ,'-c 8 -g 0.005' );
...
save(['results\syni\acc_list1',dname,svmn,attackn],'acc_list1');
save(['results\syni\acc_list2',dname,svmn,attackn],'acc_list2');
% save(['results\syni\acc_list3',dname,svmn,attackn],'acc_list3');
save(['results\syni\acc_list4',dname,svmn,attackn],'acc_list4');
save(['results\syni\acc_list5',dname,svmn,attackn],'acc_list5');
save(['results\syni\acc_list6',dname,svmn,attackn],'acc_list6');
save(['results\syni\acc_list7',dname,svmn,attackn],'acc_list7');
save(['results\syni\acc_list8',dname,svmn,attackn],'acc_list8');
% save(['results\syni\acc_list9',dname,svmn,attackn],'acc_list9');
...
for j = 1:9
    ...
    meanth = mean(ma,1);
    stdth = std(ma,0,1);
    save(['results\syni\mean',num2str(j),dname,svmn,attackn],'meanth');
    save(['results\syni\std',num2str(j),dname,svmn,attackn],'stdth');

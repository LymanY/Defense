...
function [X_attack, y_attack, X_best, y_best, base_err]=generateAttackTar(X_train, y_train, X_dev, y_dev, X_test, y_test, theta_fake, bias_fake, epsilon, options, pn) 
